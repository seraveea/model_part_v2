...
# provider_url = "~/.qlib/qlib_data/us_data"
provider_url = "../qlib_data/us_data"
qlib.init(provider_uri=provider_url, region=REG_US)
...
def main(args):
    ...
    for times in range(args.repeat):
        ...
        elif args.model_name == 'FC_model_no_F_v1_24':
...
def parse_args():
    ...
    # model
    parser.add_argument('--model_name', default='FC_model_no_F_v1_11')
    ...
    # data
    parser.add_argument('--data_set', type=str, default='nasdaq100')
    ...
    parser.add_argument('--name', type=str, default='FC_model_no_F_v1_11')

    # input for csi 300
    # parser.add_argument('--data_path', default='./data/alpha360.pkl')
    parser.add_argument('--outdir', default='./output/nas100_FC_model_no_F_v1_11_cl02')
